...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} wants access to your trippi.ai account. Please sign in first.',
  'oauth.authorize.loginButton': 'Sign in to trippi.ai',
  'oauth.authorize.requestLabel': 'Authorization Request',
  'oauth.authorize.requestDescription': 'This application is requesting access to your trippi.ai account.',
