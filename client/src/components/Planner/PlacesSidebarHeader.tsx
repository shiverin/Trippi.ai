import { Check, ChevronDown, MapPin, Plus, Search, Upload, X } from 'lucide-react';
  ...
  return (
    <div className="border-b border-edge-faint" style={{ padding: '14px 16px 10px', flexShrink: 0 }}>
      ...
      {(() => {
        ...
        ).filter(Boolean) as Array<{ id: 'all' | 'planned' | 'unplanned' | 'tracks'; label: string }>;
        return (
          ...
          const label =
            categoryFilters.size === 0
              ...
              : categoryFilters.size === 1
                ? categoryFilters.has('uncategorized')
                  ? t('places.noCategory')
              ...
              {catDropOpen && (
                ...
                >
                    ...
                    (() => {
                      ...
                      return (
                        <button
                          ...
                          className={`text-content-muted ${active ? 'bg-surface-hover' : 'bg-transparent'}`}
                          style={{
                            display: 'flex',
                            alignItems: 'center',
                            gap: 8,
                        ...
                        >
                          <div
                            className={active ? 'bg-[var(--text-faint)]' : 'bg-transparent'}
                            style={{
                              width: 16,
                              height: 16,
                              borderRadius: 4,
                  ...
                  {categoryFilters.size > 0 && (
                    <button
                      onClick={() => {
                        setCategoryFiltersLocal(new Set());
