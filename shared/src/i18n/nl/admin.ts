...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je trippi.ai-ervaring aan te passen.',
  ...
  'admin.weather.description':
    'trippi.ai gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.github.support': 'Helpt mij trippi.ai verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',
  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'trippi.ai {version} is beschikbaar. Je draait {current}.',
  ...
  'admin.update.confirmText':
    'trippi.ai wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText':
    "Je trippi.ai-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando's uit op je server:",
  'admin.update.nonDockerText':
    'Deze trippi.ai-instantie draait niet in Docker. Om bij te werken naar {version}, voer de installatie- of updatemethode die je hebt gebruikt opnieuw uit — bij Proxmox Community Scripts voer je de update bijvoorbeeld uit vanuit de LXC-console:',
