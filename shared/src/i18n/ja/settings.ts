...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'trippi.aiの旅仲間',
  'settings.about.supporters.subtitle': '皆さんの支援がtrippi.aiの未来を支えています。',
  ...
  'settings.airtrail.writeBackHint':
    '既定ではオフ: AirTrail が信頼できる情報源で、trippi.ai は読み取りのみを行います。trippi.ai で行った編集を AirTrail に書き戻すにはオンにします。',
