...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами trippi.ai',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача trippi.ai',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача trippi.ai для спільного календаря відпусток.',
