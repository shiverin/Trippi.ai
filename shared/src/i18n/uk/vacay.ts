...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами TRIPPI',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача TRIPPI',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача TRIPPI для спільного календаря відпусток.',
