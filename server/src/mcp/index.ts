...
- For PDF itineraries, include real landmark, nature, hotel, and restaurant locations as assigned places. Set \`cover_place_query\` to the most visually representative itinerary place. Trippi uses the resolved place to attach a brochure-style cover image automatically; never supply arbitrary image URLs.
