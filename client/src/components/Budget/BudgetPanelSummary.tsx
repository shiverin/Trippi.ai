...
import type { PieSegment, SettlementData } from './useBudgetPanel';
    ...
    >
      ...
      >
        ...
        {(() => {
          ...
          const full = Number(grandTotal).toLocaleString(locale, {
          ...
          return (
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, letterSpacing: '-0.03em', lineHeight: 1 }}>
              ...
              {decimalPart && (
                <span style={{ fontSize: 22, fontWeight: 500, color: theme.sub }}>
                  {sep}
                  {decimalPart}
                </span>
              )}
              <span style={{ fontSize: 22, fontWeight: 500, color: theme.sub, marginLeft: 2 }}>
              ...
              <div style={{ marginTop: 12, display: 'flex', flexDirection: 'column', gap: 8 }}>
                {settlement.flows.map((flow, i) => (
                  <div
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = theme.flowHoverBg;
                      e.currentTarget.style.borderColor = theme.flowHoverBorder;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = theme.flowBg;
                      e.currentTarget.style.borderColor = theme.flowBorder;
                    }}
                  >
                    <RingAvatar
                      userId={flow.from.user_id}
                      username={flow.from.username}
                      avatarUrl={flow.from.avatar_url}
                      size={32}
                      innerBg={theme.centerBg}
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5 }}>
                      ...
                      <div
                        style={{
                          ...
                          borderRadius: 2,
                          background:
                            'linear-gradient(90deg, rgba(239,68,68,0.1), rgba(239,68,68,0.55), rgba(239,68,68,0.3))',
                          position: 'relative',
                        }}
                      >
                        <div
                          style={{
                            ...
                            width: 0,
                            height: 0,
                            borderLeft: '6px solid rgba(239,68,68,0.55)',
                    ...
                    <RingAvatar
                      userId={flow.to.user_id}
                      username={flow.to.username}
                      avatarUrl={flow.to.avatar_url}
                      size={32}
                      innerBg={theme.centerBg}
                      textColor={theme.text}
                    />
      ...
      {pieSegments.length > 0 &&
        (() => {
          ...
          const totalFmt = Number(total).toLocaleString(locale, {
            minimumFractionDigits: decimals,
            maximumFractionDigits: decimals,
          });
            ...
            >
              ...
              <div style={{ position: 'relative', display: 'flex', justifyContent: 'center', margin: '4px 0 16px' }}>
                <svg
                  ...
                  height={200}
                  viewBox="0 0 200 200"
                  style={{ transform: 'rotate(-90deg)', filter: theme.donutShadow }}
                >
                  <defs>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ fontSize: 11.5, color: theme.sub, fontWeight: 500, marginTop: 1 }}>
