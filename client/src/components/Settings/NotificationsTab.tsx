...
export default function NotificationsTab(): React.ReactElement {
  ...
  const renderContent = () => {
    if (!matrix)
      return <p style={{ fontSize: 12, color: 'var(--text-faint)', fontStyle: 'italic' }}>{t('common.loading')}</p>;
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: '1px solid var(--border-primary)',
                  borderRadius: 6,
                  cursor: (!webhookUrl && !webhookIsSet) || webhookTesting ? 'not-allowed' : 'pointer',
                  opacity: (!webhookUrl && !webhookIsSet) || webhookTesting ? 0.5 : 1,
                }}
              >
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  borderRadius: 6,
                  cursor: ntfySaving ? 'not-allowed' : 'pointer',
                  opacity: ntfySaving ? 0.6 : 1,
                }}
              >
                {t('common.save')}
              </button>
              <button
                ...
                style={{
                  ...
                  border: '1px solid var(--border-primary)',
                  borderRadius: 6,
                  cursor: !ntfyTopic || ntfyTesting ? 'not-allowed' : 'pointer',
                  opacity: !ntfyTopic || ntfyTesting ? 0.5 : 1,
                }}
              >
        ...
        <div
          style={{
            display: 'grid',
            gridTemplateColumns: `1fr ${visibleChannels.map(() => '64px').join(' ')}`,
            gap: 4,
            paddingBottom: 6,
            marginBottom: 4,
