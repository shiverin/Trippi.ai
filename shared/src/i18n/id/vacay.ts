...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Bagikan rencana cuti kamu dengan pengguna TRIPPI lainnya',
  'vacay.owner': 'Pemilik',
  'vacay.shareEmailPlaceholder': 'Email pengguna TRIPPI',
  ...
  'vacay.inviteHint': 'Undang pengguna TRIPPI lain untuk berbagi kalender cuti bersama.',
