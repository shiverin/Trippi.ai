...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'TRIPPIの旅仲間',
  'settings.about.supporters.subtitle': '皆さんの支援がTRIPPIの未来を支えています。',
  ...
  'settings.about.description': 'TRIPPIはセルフホスト型の旅行プランナーです。',
  ...
  'settings.airtrail.writeBackHint':
    '既定ではオフ: AirTrail が信頼できる情報源で、TRIPPI は読み取りのみを行います。TRIPPI で行った編集を AirTrail に書き戻すにはオンにします。',
