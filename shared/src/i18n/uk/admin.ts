...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Увімкніть або вимкніть функції, щоб налаштувати trippi.ai під себе.',
  ...
  'admin.weather.description':
    'trippi.ai використовує Open-Meteo як джерело даних про погоду. Open-Meteo — безкоштовний сервіс з відкритим кодом, API-ключ не потрібен.',
  ...
  'admin.github.support': 'Допомагає продовжувати розробку trippi.ai',
  'admin.github.error': 'Не вдалося завантажити релізи',
  'admin.github.by': 'від',
  'admin.update.available': 'Доступне оновлення',
  'admin.update.text': 'Доступна версія trippi.ai {version}. У вас встановлено {current}.',
  ...
  'admin.update.confirmText': 'trippi.ai буде оновлено з {current} до {version}. Сервер перезапуститься автоматично.',
  ...
  'admin.update.dockerText':
    'Ваш екземпляр trippi.ai працює в Docker. Для оновлення до {version} виконайте ці команди на сервері:',
  'admin.update.nonDockerText':
    'Цей екземпляр trippi.ai не працює в Docker. Щоб оновити до {version}, повторно запустіть метод встановлення або оновлення, який ви використовували, — наприклад, у Proxmox Community Scripts запустіть оновлення з консолі LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Чистий домен, до якого прив’язані passkeys, напр. trippi.example.org. Залиште порожнім, щоб визначити його з APP_URL. Подальша зміна робить наявні passkeys недійсними.',
  'admin.passkey.origins': 'Дозволені джерела (origins)',
  'admin.passkey.originsHint':
    'Повні джерела через кому, напр. https://trippi.example.org. Залиште порожнім, щоб використати APP_URL.',
