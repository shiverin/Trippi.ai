...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки trippi.ai под себя.',
  ...
  'admin.weather.description':
    'trippi.ai использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку trippi.ai',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',
  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия trippi.ai {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'trippi.ai будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText':
    'Ваш экземпляр trippi.ai работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  'admin.update.nonDockerText':
    'Этот экземпляр trippi.ai работает не в Docker. Чтобы обновиться до {version}, повторно запустите способ установки или обновления, который вы использовали, — например, в Proxmox Community Scripts выполните обновление из консоли LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Голый домен, к которому привязаны passkeys, напр. trippi.example.org. Оставьте пустым, чтобы определить его из APP_URL. Последующее изменение делает существующие passkeys недействительными.',
  'admin.passkey.origins': 'Разрешённые источники',
  'admin.passkey.originsHint':
    'Полные источники через запятую, напр. https://trippi.example.org. Оставьте пустым, чтобы использовать APP_URL.',
