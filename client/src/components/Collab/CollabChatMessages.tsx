import { ChevronUp, MessageCircle, Reply, Trash2 } from 'lucide-react';
    ...
    <>
      ...
      {messages.length === 0 ? (
        ...
        >
          ...
          <span style={{ fontSize: 12, opacity: 0.6, fontFamily: 'var(--font-subtext)' }}>
                ...
                <React.Fragment key={msg.id}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center', padding: '4px 0' }}>
                    <span style={{ fontSize: 11, color: 'var(--text-faint)', fontStyle: 'italic' }}>
                      {msg.username} {t('collab.chat.deletedMessage') || 'deleted a message'} ·{' '}
                ...
                <div
                  style={{
                    ...
                    ...(deletingIds.has(msg.id)
                      ? { transform: 'scale(0.3)', opacity: 0, maxHeight: 0, marginTop: 0, overflow: 'hidden' }
                      : {}),
                  }}
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      onContextMenu={(e) => {
                        e.preventDefault();
                        if (canEdit) setReactMenu({ msgId: msg.id, x: e.clientX, y: e.clientY });
                      }}
                      onTouchEnd={(e) => {
                        const now = Date.now();
                    ...
                    >
                      {bigEmoji ? (
                        <div style={{ fontSize: 40, lineHeight: 1.2, padding: '2px 0' }}>{msg.text}</div>
                      ) : (
                        <div
                          style={{
                            ...
                            borderRadius: br,
                            padding: hasReply ? '4px 4px 8px 4px' : '8px 14px',
                            fontSize: 14,
                            lineHeight: 1.4,
