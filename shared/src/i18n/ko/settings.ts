...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'trippi.ai의 여행 동반자',
  'settings.about.supporters.subtitle':
    '다음 여정을 계획하는 동안, 이분들이 trippi.ai의 미래를 함께 만들어가고 있습니다. 월간 후원금은 개발과 실제 작업 시간에 직접 사용되어 trippi.ai이 오픈 소스로 유지될 수 있게 합니다.',
  ...
  'settings.airtrail.writeBackHint':
    '기본적으로 꺼져 있음: AirTrail이 신뢰할 수 있는 원본이며 trippi.ai은 읽기만 합니다. trippi.ai에서 변경한 내용을 AirTrail로 다시 보내려면 켜세요.',
