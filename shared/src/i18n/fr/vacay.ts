...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': "Partagez votre plan de vacances avec d'autres utilisateurs TRIPPI",
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': "E-mail de l'utilisateur TRIPPI",
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur TRIPPI à partager un calendrier de vacances combiné.',
