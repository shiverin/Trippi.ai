    ...
    <div>
      <div style={{ padding: '24px 28px 0' }} className="max-md:!px-4 max-md:!pt-4">
        ...
        >
          ...
          <div
            className="flex flex-wrap max-md:!mt-2 max-md:!w-full"
      ...
      <div
        style={{ display: 'flex', gap: 20, padding: '24px 28px 40px', alignItems: 'flex-start', flexWrap: 'wrap' }}
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          {categoryNames.map((cat) => (
            <BudgetCategoryTable
              ...
              dragItemCat={dragItemCat}
              setDragItemCat={setDragItemCat}
              categoryNames={categoryNames}
              reorderBudgetCategories={reorderBudgetCategories}
              reorderBudgetItems={reorderBudgetItems}
              ...
              setBudgetItemMembers={setBudgetItemMembers}
              toggleBudgetMemberPaid={toggleBudgetMemberPaid}
              th={th}
              td={td}
            />
          ))}
