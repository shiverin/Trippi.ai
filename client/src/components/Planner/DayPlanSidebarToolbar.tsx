            ...
            <Tooltip label={label} placement="bottom">
              <button
                onClick={() => {
                  ...
                  try {
                    sessionStorage.setItem(`day-expanded-${tripId}`, JSON.stringify([...next]));
                  } catch {}
                }}
                aria-label={label}
          ...
          <div style={{ position: 'relative', flexShrink: 0 }}>
            <Tooltip label={t('dayplan.reorderDays')} placement="bottom">
              <button
                ...
                onMouseEnter={(e) => {
                  if (!reorderOpen) e.currentTarget.style.background = 'var(--bg-hover)';
                }}
                onMouseLeave={(e) => {
                  if (!reorderOpen) e.currentTarget.style.background = 'transparent';
                }}
              >
