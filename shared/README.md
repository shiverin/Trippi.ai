...
Single source of truth for trippi.ai's API contracts, expressed as [Zod](https://zod.dev) schemas
...
The canonical **error envelope** is finalised in card **F5** (it must match trippi.ai's current
