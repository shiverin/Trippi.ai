 ...
 */
export function BookingCostsSection({
  reservationId,
  onCreate,
  onEdit,
  onRemove,
    ...
    return (
      <div>
        ...
        >
          ...
          <span className="text-content" style={{ fontSize: 14, fontWeight: 700, flexShrink: 0 }}>
          ...
          <button
            type="button"
            onClick={() => onRemove(linked)}
            title={t('reservations.removeExpense')}
            className="border border-edge bg-surface-card text-content-muted"
            style={{ display: 'inline-flex', padding: 7, borderRadius: 8, cursor: 'pointer' }}
          >
            <Trash2 size={13} />
  ...
  return (
    <div>
      ...
      <div className="text-content-faint" style={{ fontSize: 11, marginTop: 6 }}>
