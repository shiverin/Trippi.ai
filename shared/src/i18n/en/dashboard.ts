...
const dashboard: TranslationStrings = {
  ...
  'dashboard.todos.title': 'To-do list',
  'dashboard.todos.empty': 'All caught up.',
  'dashboard.todos.count': '{count} open',
  'dashboard.todos.noDate': 'No date',
  'dashboard.todos.noDateShort': 'No',
  'dashboard.todos.overdue': 'Overdue',
  'dashboard.todos.today': 'Today',
  'dashboard.todos.due': 'Due {date}',
  'dashboard.todos.priority': 'P{priority}',
  'dashboard.todos.untitledTrip': 'Untitled trip',
  'dashboard.todos.completeAria': 'Mark {task} complete',
  'dashboard.todos.completeError': 'Could not complete task',
