...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si trippi.ai.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj trippi.ai',
  'admin.weather.title': 'Data o počasí',
  'admin.weather.badge': 'Od 24. března 2026',
  'admin.weather.description':
    'trippi.ai používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'trippi.ai {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText':
    'trippi.ai bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText':
    'Váš trippi.ai běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  'admin.update.nonDockerText':
    'Tato instance trippi.ai neběží v Dockeru. Pro aktualizaci na verzi {version} znovu spusťte instalační nebo aktualizační metodu, kterou jste použili — například u Proxmox Community Scripts spusťte aktualizaci z konzole LXC:',
  ...
  'admin.passkey.rpIdHint':
    'Holá doména, ke které jsou přístupové klíče vázány, např. trippi.example.org. Ponechte prázdné, aby se odvodila z APP_URL. Pozdější změna zneplatní stávající přístupové klíče.',
  'admin.passkey.origins': 'Povolené origins',
  'admin.passkey.originsHint':
    'Úplné origins oddělené čárkou, např. https://trippi.example.org. Ponechte prázdné pro použití APP_URL.',
