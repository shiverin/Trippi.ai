...
<div class="pdf-footer">
  <span>made with</span>
  <img src="${absUrl('/brand/trippi-wordmark.png')}" style="height:12px;opacity:0.65;" />
</div>
...
<div class="cover">
  ...
  <div class="cover-brand"><img src="${absUrl('/brand/trippi-wordmark-light.png')}" style="height:30px;opacity:0.6;" /></div>
