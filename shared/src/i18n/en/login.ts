...
const login: TranslationStrings = {
  ...
  'login.tagline': 'your trippi, our troppi',
  ...
  'login.createAdminHint': 'Set up the first admin account for trippi.ai.',
  ...
  'login.invalidReferralLink': 'Invalid referral link',
  'login.referralAFriend': 'a friend',
  'login.referralAccepted': '{name} invited you. You both get {days} days of Pro after signup.',
