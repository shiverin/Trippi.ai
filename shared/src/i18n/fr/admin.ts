...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience trippi.ai.',
  ...
  'admin.weather.description':
    'trippi.ai utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de trippi.ai',
  'admin.github.error': 'Impossible de charger les versions',
  'admin.github.by': 'par',
  'admin.update.available': 'Mise à jour disponible',
  'admin.update.text': 'trippi.ai {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText':
    'trippi.ai sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText':
    'Votre instance trippi.ai fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  'admin.update.nonDockerText':
    "Cette instance trippi.ai ne fonctionne pas dans Docker. Pour mettre à jour vers {version}, relancez la méthode d'installation ou de mise à jour que vous avez utilisée — par exemple, sur Proxmox Community Scripts, lancez la mise à jour depuis la console LXC :",
  ...
  'admin.passkey.rpIdHint':
    "Le domaine nu auquel les passkeys sont liées, ex. trippi.example.org. Laissez vide pour le déduire d'APP_URL. Le modifier ultérieurement invalide les passkeys existantes.",
  'admin.passkey.origins': 'Origines autorisées',
  'admin.passkey.originsHint':
    'Origines complètes séparées par des virgules, ex. https://trippi.example.org. Laissez vide pour utiliser APP_URL.',
