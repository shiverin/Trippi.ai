...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do trippi.ai',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário trippi.ai',
  ...
  'vacay.inviteHint': 'Convide outro usuário trippi.ai para compartilhar um calendário de férias combinado.',
