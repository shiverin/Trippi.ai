...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_mcp.body':
    'Die MCP-Integration wurde vollständig überarbeitet. OAuth 2.1 ist jetzt die empfohlene Authentifizierungsmethode. Statische Tokens (trippi_…) sind veraltet und werden in einer zukünftigen Version entfernt.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statische trippi_-Tokens veraltet',
