    ...
    >
      ...
      >
        <div style={{ padding: '16px 20px 12px', borderBottom: '1px solid var(--border-secondary)' }}>
          <div className="text-content" style={{ fontSize: 15, fontWeight: 700 }}>
            {dayPickerPlace.name}
          </div>
        ...
        <div style={{ overflowY: 'auto', padding: '8px 12px' }}>
          ...
          <button
            onClick={() => {
              onPlaceClick(dayPickerPlace.id);
              setDayPickerPlace(null);
              setMobileShowDays(false);
            }}
              ...
              >
                ...
                <ChevronDown
                  ...
                  style={{
                    ...
                    transform: mobileShowDays ? 'rotate(180deg)' : 'none',
                  ...
                  {days.map((day, i) => (
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div className="text-content" style={{ fontSize: 13, fontWeight: 500 }}>
          ...
          {canEditPlaces && (
            <button
              onClick={() => {
                onDeletePlace(dayPickerPlace.id);
                setDayPickerPlace(null);
                setMobileShowDays(false);
              }}
              style={{
