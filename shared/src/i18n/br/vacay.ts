...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do TRIPPI',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário TRIPPI',
  ...
  'vacay.inviteHint': 'Convide outro usuário TRIPPI para compartilhar um calendário de férias combinado.',
