...
export function PackingHeader(S: PackingState) {
  ...
  return (
    <div
      style={{
        padding: inlineHeader ? '20px 24px 16px' : '0 0 16px',
        flexShrink: 0,
        borderBottom: inlineHeader ? '1px solid rgba(0,0,0,0.06)' : undefined,
      }}
    >
      <div
        style={{
          display: 'flex',
          alignItems: inlineHeader ? 'flex-start' : 'center',
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 99,
                  transition:
                    'width 600ms cubic-bezier(0.23, 1, 0.32, 1), background 400ms ease, box-shadow 400ms ease',
                  background:
                    fortschritt === 100 ? 'linear-gradient(90deg, #10b981 0%, #34d399 100%)' : 'var(--accent)',
                  width: `${fortschritt}%`,
