...
On a fresh trippi.ai instance with no existing accounts, the registration form opens immediately. The first account created is automatically assigned the **admin** role.
