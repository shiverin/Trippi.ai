...
const admin: TranslationStrings = {
  ...
  'admin.addons.subtitle': 'Увімкніть або вимкніть функції, щоб налаштувати TRIPPI під себе.',
  ...
  'admin.weather.description':
    'TRIPPI використовує Open-Meteo як джерело даних про погоду. Open-Meteo — безкоштовний сервіс з відкритим кодом, API-ключ не потрібен.',
  ...
  'admin.github.support': 'Допомагає продовжувати розробку TRIPPI',
  'admin.github.error': 'Не вдалося завантажити релізи',
  'admin.github.by': 'від',
  'admin.update.available': 'Доступне оновлення',
  'admin.update.text': 'Доступна версія TRIPPI {version}. У вас встановлено {current}.',
  ...
  'admin.update.confirmText': 'TRIPPI буде оновлено з {current} до {version}. Сервер перезапуститься автоматично.',
  ...
  'admin.update.dockerText':
    'Ваш екземпляр TRIPPI працює в Docker. Для оновлення до {version} виконайте ці команди на сервері:',
  'admin.update.nonDockerText':
    'Цей екземпляр TRIPPI не працює в Docker. Щоб оновити до {version}, повторно запустіть метод встановлення або оновлення, який ви використовували, — наприклад, у Proxmox Community Scripts запустіть оновлення з консолі LXC:',
