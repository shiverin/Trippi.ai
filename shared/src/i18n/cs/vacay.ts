...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Sdílejte svůj plán dovolené s ostatními uživateli trippi.ai',
  'vacay.owner': 'Vlastník',
  'vacay.shareEmailPlaceholder': 'E-mail uživatele trippi.ai',
  ...
  'vacay.inviteHint': 'Pozvěte jiného uživatele trippi.ai ke sdílení společného kalendáře dovolených.',
