                ...
                const count =
                  tab.id === 'all'
                    ...
                    : tab.id === 'starred'
                      ...
                      : tab.id === 'pdf'
                        ? files.filter((f) => (f.mime_type || '').includes('pdf') || /\.pdf$/i.test(f.original_name))
                            .length
                        : tab.id === 'image'
                          ? files.filter((f) => (f.mime_type || '').startsWith('image/')).length
                          : tab.id === 'doc'
                            ? files.filter((f) => /\.(docx?|xlsx?|txt|csv)$/i.test(f.original_name)).length
                            : tab.id === 'collab'
                  ...
                  >
                    {TabIcon ? (
                      <TabIcon
                        ...
                        color={active ? '#facc15' : 'currentColor'}
                      />
                    ) : null}
