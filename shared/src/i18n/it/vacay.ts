...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti TRIPPI',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': "Email dell'utente TRIPPI",
  ...
  'vacay.inviteHint': 'Invita un altro utente TRIPPI a condividere un calendario ferie combinato.',
