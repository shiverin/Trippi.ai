...
const admin: TranslationStrings = {
  ...
  'admin.passkey.rpIdHint':
    'O domínio puro ao qual as passkeys ficam vinculadas, ex.: trippi.example.org. Deixe vazio para derivá-lo de APP_URL. Alterá-lo depois invalida as passkeys existentes.',
  'admin.passkey.origins': 'Origens permitidas',
  'admin.passkey.originsHint':
    'Origens completas separadas por vírgula, ex.: https://trippi.example.org. Deixe vazio para usar APP_URL.',
