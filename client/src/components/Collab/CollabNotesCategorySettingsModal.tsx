...
export function CategorySettingsModal({
  ...
  const handleAddCategory = () => {
    ...
    setLocalColors((prev) => ({
      ...prev,
      [newCatName.trim()]: NOTE_COLORS[Object.keys(prev).length % NOTE_COLORS.length].value,
    }));
    setNewCatName('');
  };
        ...
        <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                {NOTE_COLORS.map((c) => (
                  <button
                    ...
                    style={{
                      ...
                      padding: 0,
                      outline:
                        (localColors[cat] || NOTE_COLORS[0].value) === c.value
          ...
          <div style={{ display: 'flex', gap: 6, marginTop: 4 }}>
            ...
            <button
              ...
              style={{
                background: newCatName.trim() ? 'var(--accent)' : 'var(--border-primary)',
