...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti trippi.ai',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': "Email dell'utente trippi.ai",
  ...
  'vacay.inviteHint': 'Invita un altro utente trippi.ai a condividere un calendario ferie combinato.',
