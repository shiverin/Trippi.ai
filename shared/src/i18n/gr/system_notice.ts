...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_thankyou.body':
    'Πριν συνεχίσετε — σας ευχαριστώ. Το trippi.ai ξεκίνησε ως ένας σχεδιαστής για τα δικά μου ταξίδια, και αυτή η κοινότητα το διαμόρφωσε με αναφορές, μεταφράσεις, ιδέες και πραγματικά ταξίδια.\n\nΚαθώς το trippi.ai μεγαλώνει, ορισμένα μέρη μπορεί να εξελιχθούν σε φιλοξενούμενες υπηρεσίες ή πληρωμένα πλάνα ώστε το έργο να συνεχίσει να βελτιώνεται. Θα κρατώ αυτές τις αλλαγές σαφείς και εστιασμένες σε καλύτερο σχεδιασμό ταξιδιών.\n\n[Γίνετε μέλος της κοινότητας στο Discord](https://discord.gg/7Q6M6jDwzf)',
