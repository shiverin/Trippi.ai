...
const settings: TranslationStrings = {
  ...
  'settings.usage.currentPlan': 'Current plan',
  'settings.usage.loadingPlan': 'Checking plan',
  'settings.usage.loadingAccess': 'Loading access',
  'settings.usage.freePlan': 'Free plan',
  'settings.usage.proPlan': 'Pro',
  'settings.usage.agencyPlan': 'Agency',
  'settings.usage.trialPlan': 'Trial',
  'settings.usage.referralPro': 'Referral Pro',
  'settings.usage.adminPlan': 'Admin',
  'settings.usage.adminAccess': 'Unlimited admin access',
  'settings.usage.freeAccess': 'No Pro access active',
  'settings.usage.activeSubscription': 'Active subscription',
  'settings.usage.lessThanDay': 'Less than 1 day',
  'settings.usage.day': '{count} day',
  'settings.usage.days': '{count} days',
  'settings.usage.referralDaysLeft': '{days} left',
  'settings.usage.trialEndsIn': 'Trial ends in {days}',
  'settings.usage.endsIn': 'Ends in {days}',
  'settings.usage.renewsIn': 'Renews in {days}',
  'settings.usage.activeUntil': 'Active until {date}',
  ...
  'settings.usage.lockedTripsHint': 'Free access keeps your newest {count} owned trips editable.',
  'settings.usage.tripMembers': 'Trip members',
  'settings.usage.tripMembersHint': 'Maximum collaborators per trip for your current plan.',
  'settings.usage.referralActiveDays': 'Referral days active',
  'settings.usage.referralPendingDays': 'Referral days queued',
  'settings.usage.referralMaxDays': 'Referral cap',
};
