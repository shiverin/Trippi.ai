...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями trippi.ai',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя trippi.ai',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя trippi.ai для совместного календаря отпусков.',
