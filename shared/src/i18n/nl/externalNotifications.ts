...
const nl: NotificationLocale = {
  email: {
    footer: 'Je ontvangt dit omdat je meldingen hebt ingeschakeld in trippi.ai.',
    manage: 'Voorkeuren beheren',
    madeWith: 'Made with',
    openTrippi: 'trippi.ai openen',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} nodigt je uit om vakantieplannen te fuseren. Open trippi.ai om te accepteren of af te wijzen.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Nieuwe trippi.ai-versie beschikbaar',
      body: `trippi.ai ${p.version} is nu beschikbaar. Bezoek het beheerderspaneel om bij te werken.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'Hallo',
    body: 'We hebben een verzoek ontvangen om het wachtwoord voor je trippi.ai-account te resetten. Klik op de knop hieronder om een nieuw wachtwoord in te stellen.',
